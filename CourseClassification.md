...
* Midterm tests: max. 40 points (4 short written tests, paper-based, 10 points each)
* Seminar paper: max 30 points 
...
**Seminární práce** - zadání bude upřesněno

--- 

**Závěrečná zkouška** více termínů v průběhu zkouškového období: viz InSIS.

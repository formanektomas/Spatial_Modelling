...
# Literature and supporting materials for the course Spatial Modelling

## Spatial data and basic analysis 

+ [Pebesma & Bivand: Spatial Data Science with Applications in R](https://r-spatial.org/book/){:target="_blank"}  
+ [Lovelace et al.: Geocomputation with R](https://r.geocompx.org/index.html){:target="_blank"}  

## Spatial statistics and spatial modelling 
